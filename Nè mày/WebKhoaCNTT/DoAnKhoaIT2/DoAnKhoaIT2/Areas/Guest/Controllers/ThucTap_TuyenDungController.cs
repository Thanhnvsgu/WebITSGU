...
{
    public class ThucTap_TuyenDungController : Controller
    {
        // GET: ThucTap_TuyenDung
        public ActionResult Index()
        {
            return View();
        }
        public ActionResult TT_TD(string maloai,int page=1,int pagesize=3)
        {
        ...
        public ActionResult ThucTap1(string mabaidang)
        {
            var dao = new TT_TD();
